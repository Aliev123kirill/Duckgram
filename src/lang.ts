const lang = {
  ...
  'Deactivated.Version.Title': 'Duckgram has updated...',
  ...
  'PinnedChatsShort': 'Pinned',
  'PinnedChats.Description': 'Chats you pinned from all folders',
  'Call': 'Call',
  ...
  'Proxy.Type': 'Connection Type',
  'Proxy.Type.MTProto': 'MTProto Proxy',
  'Proxy.Type.SOCKS5': 'SOCKS5',
  'Proxy.Type.HTTP': 'HTTP',
  'Proxy.Add': 'Add Proxy',
  'Proxy.Add.Button': 'Add',
  'Proxy.Import': 'Import',
  'Proxy.ImportLink': 'Proxy link (t.me/proxy?... or tg://proxy?...)',
  'Proxy.Server': 'Server',
  'Proxy.Port': 'Port',
  'Proxy.Secret': 'Secret (optional)',
  'Proxy.Username': 'Username',
  'Proxy.Password': 'Password',
  'Proxy.Servers': 'Saved Proxies',
  'Proxy.Browser.Note': 'In the browser only the MTProto proxy can route traffic. SOCKS5 and HTTP entries are saved, but the connection stays direct.',
  ...
  'GhostMode.Title': 'Ghost Mode',
  'GhostMode.Subtitle': 'Hide your online status, last seen and read receipts. Read messages with zero trace — nobody will know you were here.',
  'GhostMode.Warning': 'Sending a message, calling or reacting will reveal you. Unread badges may re-appear after the next sync.',
  'PinnedChats.LimitTitle': 'Max Pinned Chats',
  'PinnedChats.LimitDefault': 'Default',
  ...
  'AudioAndVideoTranscription.TrialLeft': {
    'one_value': 'You have **%1$d** free transcription left this week.',
    'other_value': 'You have **%1$d** free transcriptions left this week.'
  },
  'AudioAndVideoTranscription.VoiceTooLong': 'This voice message is too long to be transcribed.',
  'AudioAndVideoTranscription.FloodWait': 'Voice message transcription is currently unavailable. Please try again later.',
  ...
  'Archive.Empty.Subtitle': 'Chats you archive will be moved here.',
  ...
  'AboutTab.Title': 'About Duckgram',
  'AboutTab.ProjectName': 'Project name',
  'AboutTab.Technology': 'Built on',
  'AboutTab.Version': 'Version',
  'AboutTab.Status': 'Status',
  'AboutTab.StatusPlaceholder': 'Temporary placeholder',
  'AboutTab.SourceCode': 'Source code',
  'AboutTab.OpenGitHub': 'Open GitHub',
  'AboutTab.UniqueTech': 'Unique technology',
  'AboutTab.TechDescription': 'We use a unique technology to bypass blocks, which ensures stable access even under restrictions.',
